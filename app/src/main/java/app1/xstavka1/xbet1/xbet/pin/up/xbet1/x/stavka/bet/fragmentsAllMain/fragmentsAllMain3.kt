...
import app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.databinding.Fragmentsallmain3Binding


class fragmentsAllMain3 : Fragment() {

    private var fragmentsAllMain3: Fragmentsallmain3Binding? = null
    private val fragmentsAllMain get() = fragmentsAllMain3!!
    ...
    override fun onCreateView(
        ...
        fragmentsAllMain3 = Fragmentsallmain3Binding.inflate(inflater,container,false)
