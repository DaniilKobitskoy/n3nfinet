...
import app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.databinding.Fragmentsallmain7Binding

class fragmentsAllMain7 : Fragment() {
    private var fragmentsAllMain7: Fragmentsallmain7Binding? = null
    private val fragmentsAllMain get() = fragmentsAllMain7!!
    ...
    override fun onCreateView(
        ...
        fragmentsAllMain7 = Fragmentsallmain7Binding.inflate(inflater,container,false)
