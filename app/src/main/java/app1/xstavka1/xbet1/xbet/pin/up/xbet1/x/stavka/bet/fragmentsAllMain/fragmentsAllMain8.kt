...
import app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.databinding.Fragmentsallmain8Binding


class fragmentsAllMain8 : Fragment() {
    private var fragmentsAllMain8: Fragmentsallmain8Binding? = null
    private val fragmentsAllMain get() = fragmentsAllMain8!!
    ...
    override fun onCreateView(
        ...
        fragmentsAllMain8 = Fragmentsallmain8Binding.inflate(inflater,container,false)
