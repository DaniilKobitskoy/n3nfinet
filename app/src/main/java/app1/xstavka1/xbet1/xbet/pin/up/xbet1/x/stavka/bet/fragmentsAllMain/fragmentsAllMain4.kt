package app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.betcitysportFragments
...
import app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.databinding.Fragmentsallmain4Binding


class fragmentsAllMain4 : Fragment() {

    private var fragmentsAllMain4: Fragmentsallmain4Binding? = null
    private val fragmentsAllMain get() = fragmentsAllMain4!!
    ...
    override fun onCreateView(
        ...
        fragmentsAllMain4 = Fragmentsallmain4Binding.inflate(inflater,container,false)
