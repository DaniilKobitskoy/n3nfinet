...
import app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.databinding.Fragmentsallmain9Binding

class fragmentsAllMain9 : Fragment() {

    private var fragmentsAllMain9: Fragmentsallmain9Binding? = null
    private val fragmentsAllMain get() = fragmentsAllMain9!!
    ...
    override fun onCreateView(
        ...
        fragmentsAllMain9 = Fragmentsallmain9Binding.inflate(inflater,container,false)
