...
import app1.xstavka1.xbet1.xbet.pin.up.xbet1.x.stavka.bet.databinding.Fragmentsallmain5Binding


class fragmentsAllMain5 : Fragment() {

    private var fragmentsAllMain5: Fragmentsallmain5Binding? = null
    private val fragmentsAllMain get() = fragmentsAllMain5!!
    ...
    override fun onCreateView(
        ...
        fragmentsAllMain5 = Fragmentsallmain5Binding.inflate(inflater,container,false)
